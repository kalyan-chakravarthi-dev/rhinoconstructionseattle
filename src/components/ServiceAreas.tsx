      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 lg:mb-16">
          ...
          <p className="text-muted-foreground text-lg lg:text-xl">
            {t('serviceAreas.subtitle')} {COMPANY_INFO.serviceRadius}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-lg border border-border">
            ...
            <div className="relative h-[50vh] lg:h-[500px] bg-muted">
              ...
              <iframe
                ...
                title="Rhino Remodeler Service Area - Seattle and surrounding areas"
              ...
              <div className="absolute bottom-4 left-4 bg-card/95 backdrop-blur-sm rounded-lg px-4 py-2 shadow-lg border border-border">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="font-medium text-foreground">{t('serviceAreas.serviceRadius')}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-2xl p-6 lg:p-8 shadow-lg border border-border">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="font-semibold text-foreground text-lg">{t('serviceAreas.citiesWeServe')}</h3>
                <p className="text-sm text-muted-foreground">{t('serviceAreas.kingCounty')}</p>
              </div>
            </div>
              ...
              {cities.map((city) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-1 text-sm text-muted-foreground">
                    ...
                    <span>{city.primary ? t('serviceAreas.primaryLocation') : city.time}</span>
                  </div>
                </div>
              ))}
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <Button variant="default" size="sm" asChild>
                    <Link to="/contact">{t('serviceAreas.checkAvailability')}</Link>
                  </Button>
                </div>
              </div>
            </div>
