...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1e293b] text-[#e2e8f0]">
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <span className="font-bold text-lg text-[#f8fafc]">RHINO</span>
                <span className="font-medium text-lg text-[#94a3b8] ml-1">CONSTRUCTION</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-[#334155] hover:bg-secondary flex items-center justify-center transition-colors duration-200"
                >
          ...
          <div>
            <h4 className="text-[#f8fafc] font-semibold text-lg mb-5">Quick Links</h4>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-[#94a3b8] hover:text-secondary transition-colors duration-200 text-sm"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          {/* Column 3 - Services */}
          <div>
            <h4 className="text-[#f8fafc] font-semibold text-lg mb-5">Our Services</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="text-[#f8fafc] font-semibold text-lg mb-5">Get In Touch</h4>
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a
                    ...
                    className="text-[#f8fafc] hover:text-secondary transition-colors font-medium"
                  >
                    (206) 555-RHINO
                  </a>
                </div>
              ...
              <li className="flex items-start gap-3">
                ...
                <a
                  ...
                  className="text-[#94a3b8] hover:text-secondary transition-colors text-sm break-all"
                >
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-[#94a3b8] text-sm">
                  <span className="text-secondary font-medium">Emergency:</span><br />
                  24/7 Available
                </span>
              </li>
            </ul>
      ...
      <div className="border-t border-[#334155]">
        <div className="container mx-auto px-4 lg:px-8 py-6">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            {/* Copyright & License */}
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-sm text-[#64748b] text-center sm:text-left">
              <span>© {currentYear} Rhino Construction. All rights reserved.</span>
              <span className="hidden sm:inline">|</span>
              <span>Licensed, Bonded & Insured | License #123456</span>
            </div>

            {/* Payment Methods */}
            <div className="flex items-center gap-3">
              <span className="text-xs text-[#64748b] mr-2">We Accept:</span>
              {/* Visa */}
              <div className="w-10 h-6 bg-[#f8fafc] rounded flex items-center justify-center">
