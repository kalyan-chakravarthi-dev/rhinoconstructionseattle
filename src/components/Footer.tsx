...
const PinterestIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
    <path d="M12 0a12 12 0 0 0-4.37 23.17c-.1-.94-.2-2.4.04-3.44l1.4-5.96s-.36-.72-.36-1.78c0-1.67.97-2.92 2.17-2.92 1.02 0 1.52.77 1.52 1.7 0 1.03-.66 2.58-1 4.01-.28 1.2.6 2.18 1.78 2.18 2.13 0 3.77-2.25 3.77-5.5 0-2.87-2.06-4.88-5.01-4.88-3.41 0-5.42 2.56-5.42 5.21 0 1.03.4 2.14.89 2.74a.36.36 0 0 1 .08.34l-.33 1.36c-.05.22-.18.27-.4.16-1.5-.7-2.43-2.9-2.43-4.67 0-3.8 2.76-7.3 7.96-7.3 4.17 0 7.42 2.98 7.42 6.95 0 4.15-2.61 7.49-6.24 7.49-1.22 0-2.37-.63-2.76-1.38l-.75 2.86c-.27 1.05-1.01 2.36-1.5 3.16A12 12 0 1 0 12 0z" />
  </svg>
);

const socialLinks = [
  { icon: Facebook, href: "https://www.facebook.com/rhinoremodeler", label: "Facebook" },
  { icon: Instagram, href: "https://www.instagram.com/rhinoremodeler", label: "Instagram" },
  { icon: XIcon, href: "https://x.com/RhinoRemodeler", label: "X (Twitter)" },
  { icon: Linkedin, href: "https://www.linkedin.com/in/rhinoremodeler", label: "LinkedIn" },
  { icon: TikTokIcon, href: "https://www.tiktok.com/@rhinoremodeler", label: "TikTok" },
  { icon: PinterestIcon, href: "https://www.pinterest.com/rhinoremodeler/", label: "Pinterest" },
];
